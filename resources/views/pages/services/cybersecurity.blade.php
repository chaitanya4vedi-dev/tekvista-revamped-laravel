...
<section class="service-hero relative isolate overflow-hidden">
    <img src="{{ $visuals['security'] }}" alt="Cybersecurity operations center" class="absolute inset-0 -z-20 h-full w-full object-cover tv-hero-focus-security">
    <div class="absolute inset-0 -z-10 bg-[#020817]/55"></div>
    <div class="absolute inset-0 -z-10" style="background: linear-gradient(110deg, rgba(2,6,23,.96) 0%, rgba(2,6,23,.78) 44%, rgba(2,6,23,.42) 100%);"></div>
    <div class="absolute inset-0 -z-10" style="background: radial-gradient(circle at 66% 48%, rgba(0,140,255,.22), transparent 31rem);"></div>
    ...
    <div class="grid gap-6 lg:grid-cols-2">
        ...
        <article class="neo-card p-6 sm:p-8">
            ...
            <div class="mt-5 grid gap-3 sm:grid-cols-2">
                <a href="{{ route('product.partner', ['vendor' => 'fortinet']) }}" class="logo-chip"><img src="{{ asset('images/tekvista/logos/fortinet.svg') }}" alt="FortiGate by Fortinet"><p class="logo-chip-title">FortiGate (Fortinet)</p><p class="logo-chip-name">Next-generation firewall deployment and policy hardening services.</p></a>
                <a href="{{ route('product.partner', ['vendor' => 'sophos']) }}" class="logo-chip"><img src="{{ asset('images/tekvista/logos/sophos.svg') }}" alt="Sophos"><p class="logo-chip-title">Sophos</p><p class="logo-chip-name">Firewall, endpoint, and synchronized security rollout for enterprises.</p></a>
                <a href="{{ route('product.partner', ['vendor' => 'fortinet']) }}" class="logo-chip"><img src="{{ asset('images/tekvista/logos/fortinet.svg') }}" alt="FortiMail by Fortinet"><p class="logo-chip-title">FortiMail</p><p class="logo-chip-name">Secure email gateway implementation and managed security operations.</p></a>
                ...
                <a href="{{ route('product.partner', ['vendor' => 'seqrite']) }}" class="logo-chip"><img src="{{ asset('images/tekvista/logos/seqrite.png') }}" alt="Seqrite"><p class="logo-chip-title">Seqrite</p><p class="logo-chip-name">We provide Seqrite endpoint protection, XDR, and enterprise security services.</p></a>
                <a href="{{ route('product.partner', ['vendor' => 'microsoft']) }}" class="logo-chip"><img src="{{ asset('images/tekvista/logos/microsoft.svg') }}" alt="Microsoft Defender"><p class="logo-chip-title">Microsoft Defender</p><p class="logo-chip-name">Identity and endpoint threat protection with continuous policy tuning.</p></a>
            </div>
        </article>
    </div>
</section>
