...
<section class="service-hero relative isolate overflow-hidden">
    <img src="{{ $odooService['heroImage'] ?? $visuals['odoo'] }}" alt="{{ $odooService['name'] }} service by Tekvista" class="absolute inset-0 -z-20 h-full w-full object-cover">
    ...
    <div class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div class="mt-7 flex flex-col items-center text-center">
            ...
            <p class="mt-5 section-kicker hero-kicker-readable">{{ $odooService['heroKicker'] }}</p>
