...
<section class="service-hero">
    <img src="{{ $visuals['mail'] }}" alt="Enterprise email security operations" class="absolute inset-0 -z-20 h-full w-full object-cover">
...
<section class="mx-auto mt-10 max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="neo-card p-6 sm:p-8">
        ...
        <div class="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="logo-chip"><img src="{{ asset('images/tekvista/logos/fortinet.svg') }}" alt="FortiMail by Fortinet"><p class="logo-chip-title">FortiMail</p><p class="logo-chip-name">Secure email gateway with anti-phishing and ATP policy controls.</p></div>
            <div class="logo-chip"><img src="{{ asset('images/tekvista/logos/sophos.svg') }}" alt="Sophos Email"><p class="logo-chip-title">Sophos Email</p><p class="logo-chip-name">Business email threat detection and mailbox protection workflows.</p></div>
            ...
            <div class="logo-chip"><img src="{{ asset('images/tekvista/logos/seqrite.png') }}" alt="Seqrite"><p class="logo-chip-title">Seqrite</p><p class="logo-chip-name">Enterprise email and endpoint threat protection deployment and support.</p></div>
            <div class="logo-chip"><img src="{{ asset('images/tekvista/logos/microsoft.svg') }}" alt="Microsoft Defender"><p class="logo-chip-title">Microsoft Defender</p><p class="logo-chip-name">M365-native email threat protection, investigations, and response support.</p></div>
